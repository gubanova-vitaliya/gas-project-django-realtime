...
var require_objectWithoutPropertiesLoose = __commonJS({
  "node_modules/@babel/runtime/helpers/objectWithoutPropertiesLoose.js"(exports, module) {
    ...
    module.exports = _objectWithoutPropertiesLoose13, module.exports.__esModule = true, module.exports["default"] = module.exports;
  }
});
...
var require_utils = __commonJS({
  "node_modules/uncontrollable/lib/cjs/utils.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault();
    exports.__esModule = true;
    exports.uncontrolledPropTypes = uncontrolledPropTypes;
    exports.isProp = isProp;
    exports.defaultKey = defaultKey2;
    ...
    function readOnlyPropType(handler, name) {
      return function(props, propName) {
        if (props[propName] !== void 0) {
          if (!props[handler]) {
            return new Error("You have provided a `" + propName + "` prop to `" + name + "` " + ("without an `" + handler + "` handler prop. This will render a read-only field. ") + ("If the field should be mutable use `" + defaultKey2(propName) + "`. ") + ("Otherwise, set `" + handler + "`."));
          }
        }
      };
    }
    function uncontrolledPropTypes(controlledValues, displayName) {
      ...
      Object.keys(controlledValues).forEach(function(prop) {
        propTypes8[defaultKey2(prop)] = noop8;
        if (true) {
          ...
          propTypes8[prop] = readOnlyPropType(handler, displayName);
        }
      });
      return propTypes8;
    }
...
var require_uncontrollable = __commonJS({
  "node_modules/uncontrollable/lib/cjs/uncontrollable.js"(exports, module) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault();
    ...
    function uncontrollable(Component2, controlledValues, methods) {
      ...
      var canAcceptRef = Utils.canAcceptRef(Component2);
      var controlledProps = Object.keys(controlledValues);
      var PROPS_TO_OMIT = controlledProps.map(Utils.defaultKey);
      !(canAcceptRef || !methods.length) ? true ? (0, _invariant.default)(false, "[uncontrollable] stateless function components cannot pass through methods because they have no associated instances. Check component: " + displayName + ", attempting to pass through methods: " + methods.join(", ")) : invariant(false) : void 0;
      var UncontrolledComponent = (function(_React$Component) {
        (0, _inheritsLoose2.default)(UncontrolledComponent2, _React$Component);
          ...
          controlledProps.forEach(function(propName) {
            ...
            var handleChange = function handleChange2(value) {
              ...
              if (!_this.unmounted) _this.setState(function(_ref) {
                ...
                return {
                  values: (0, _extends3.default)(/* @__PURE__ */ Object.create(null), values2, (_extends2 = {}, _extends2[propName] = value, _extends2))
                };
              });
            };
        ...
        UncontrolledComponent2.getDerivedStateFromProps = function getDerivedStateFromProps(props, _ref2) {
          ...
          var nextState = {
            values: (0, _extends3.default)(/* @__PURE__ */ Object.create(null), values),
            prevProps: {}
          };
          controlledProps.forEach(function(key) {
        ...
        _proto.render = function render() {
          var _this2 = this;
          var _this$props2 = this.props, innerRef = _this$props2.innerRef, props = (0, _objectWithoutPropertiesLoose22.default)(_this$props2, ["innerRef"]);
          ...
          return _react.default.createElement(Component2, (0, _extends3.default)({}, props, newProps, this.handlers, {
...
function useUncontrolledProp2(propValue, defaultValue, handler) {
  ...
  return [isProp ? propValue : stateValue, (0, import_react36.useCallback)((...args) => {
...
function useWrappedRefWithWarning(ref, componentName) {
  ...
  const warningRef = (0, import_react48.useCallback)((refValue) => {
    !(refValue == null || !refValue.isReactComponent) ? true ? (0, import_invariant2.default)(false, `${componentName} injected a ref to a provided \`as\` component that resolved to a component instance instead of a DOM element. Use \`React.forwardRef\` to provide the injected ref to the class component as a prop in order to pass it directly to a DOM element`) : (0, import_invariant2.default)(false) : void 0;
  }, [componentName]);
...
var Modal2 = React101.forwardRef(({
  ...
  const renderBackdrop = (0, import_react73.useCallback)((backdropProps) => (0, import_jsx_runtime93.jsx)("div", {
    ...backdropProps,
...
var Offcanvas = React112.forwardRef(({
  ...
  const renderBackdrop = (0, import_react79.useCallback)((backdropProps) => (0, import_jsx_runtime104.jsx)("div", {
    ...backdropProps,
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime121.jsxs)(import_jsx_runtime120.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react86.cloneElement)(children, triggerProps), (0, import_jsx_runtime119.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
